...
export const NotificationProvider = ({ children }) => {
  ...
  const value = {
    ...
    showSuccess: addSuccessNotification,
    showError: addErrorNotification,
    showWarning: addWarningNotification,
    showInfo: addInfoNotification,
    showSuccessRU: addSuccessNotification,
    showErrorRU: addErrorNotification,
    showWarningRU: addWarningNotification,
