  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-surface-card border border-accent-primary border-opacity-30 rounded-lg p-6">
        ...
        <div className="mb-6">
          <h4 className="text-lg font-rajdhani font-semibold text-white mb-3">Live Players</h4>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-rajdhani font-medium text-text-secondary mb-2">
                Max My Bets
        ...
        <div>
          <h4 className="text-lg font-rajdhani font-semibold text-white mb-3">Bot Players</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-rajdhani font-medium text-text-secondary mb-2">
                Max Available Bots
