  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center py-4">
        <h3 className={`text-5xl font-russo mb-6 ${resultConfig.color} animate-pulse`} style={{ willChange: 'transform' }}>
        ...
        <div className="grid grid-cols-3 gap-4 items-center">
          ...
          <div className="text-center">
            <div className={`w-20 h-20 mx-auto mb-3 rounded-full border-4 ${
              (showInconsistent ? 'border-red-500' : (result === 'win' ? 'border-green-400' : result === 'lose' ? 'border-red-400' : 'border-yellow-400'))
          ...
          <div className="text-center">
            <div className={`w-20 h-20 mx-auto mb-3 rounded-full border-4 ${
              (showInconsistent ? 'border-red-500' : (result === 'lose' ? 'border-green-400' : result === 'win' ? 'border-red-400' : 'border-yellow-400'))
      ...
      <div className="bg-surface-sidebar rounded-xl p-6 border border-border-primary">
        ...
        <div className="space-y-3">
          ...
          {commissionAmount > 0 && (
            <div className="flex justify-between items-center py-2 border-b border-border-primary border-opacity-30">
              <span className="text-text-secondary font-rajdhani">Platform Commission (3%):</span>
