...
def create_mock_completed_cycle(bot_id: str, cycle_number: int = 1):
    ...
    return {
        ...
        "losses_count": 6,
        "draws_count": 3,
        "total_bet_amount": 809,  # ✅ Правильная общая сумма
        "total_winnings": 356,    # ✅ Правильная сумма выигрышей
        "total_losses": 291,      # ✅ Правильная сумма потерь
        "total_draws": 162,       # ✅ Правильная сумма ничьих
        "net_profit": 65,         # ✅ Правильная прибыль (356-291)
        "is_profitable": True,
        "active_pool": 647,       # ✅ Правильный активный пул (356+291)
        "roi_active": 10.05,      # ✅ Правильный ROI (65/647*100)
...
async def get_bot_cycle_bets(bot_id: str):
    ...
    return {
        ...
        "bot_name": bot["name"],
        "cycle_length": 16,
        "exact_cycle_total": 809,  # ✅ Правильное значение
        "sums": {
            "wins_sum": 356,    # ✅ Правильные суммы
            "losses_sum": 291,  # ✅
            "draws_sum": 162,   # ✅
            "total_sum": 809,   # ✅
            "active_pool": 647, # ✅
...
if __name__ == "__main__":
    ...
    print("📊 Данные содержат правильные расчёты:")
    print("   - Общая сумма цикла: 809")
    print("   - Выигрыши: 356, Потери: 291, Ничьи: 162") 
    print("   - Активный пул: 647, Прибыль: 65, ROI: 10.05%")
