...
**ОБНОВЛЕНИЯ LOBBY:**
- ✅ Добавлены табы "Live Players" и "Bot Players" как в Profile
- ✅ Структура "Live Players": левая колонка (My Bets + Ongoing Battles), правая колонка (Available Bets)
- ✅ Все границы блоков изменены на #23d364 (border-accent-primary)
- ✅ Каждый блок имеет иконку, название и количество ставок
- ✅ Пагинация по 10 элементов для всех блоков
