...
- ✅ Исправлена рамка выделения в боковом меню (свернутом и развернутом)
- ✅ Все границы во всех компонентах изменены на #23d364 с прозрачностью 30%
- ✅ Границы сделаны очень тонкими и едва видными
- ✅ Hover эффекты с усилением прозрачности границ до 100%
- ✅ Обновлены компоненты: Sidebar, Lobby, MyBets, Profile, Shop, CreateGame
- ✅ Рамка выделения не выходит за границы меню и не перекрывает иконки
