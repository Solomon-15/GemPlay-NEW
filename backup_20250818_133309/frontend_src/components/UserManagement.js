      ...
      <div className="bg-surface-card border border-red-500 border-opacity-30 rounded-lg p-6 max-w-lg w-full mx-4">
        ...
        <div className="flex space-x-3">
          ...
          >
            {bulkActionLoading ? (
              <>
                <Loader size={16} ariaLabel="Bulk deleting" />
              </>
            ) : (
              <>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          >
                            {resettingUserBets === user.id ? (
                              <Loader size={12} ariaLabel="Resetting bets" />
                            ) : (
                              <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                              </svg>
                          ...
                          >
                            {resettingUserBalance === user.id ? (
                              <Loader size={12} ariaLabel="Resetting balance" />
                            ) : (
                              <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-3">
                ...
                >
                  {resettingBalances ? (
                    <>
                      <Loader size={16} ariaLabel="Resetting balances" />
                      Сбрасываем...
                    </>
                  ) : (
              ...
              <div className="flex space-x-3">
                ...
                >
                  {unfreezingCommission ? (
                    <>
                      <Loader size={16} ariaLabel="Unfreezing commission" />
                      Размораживаем...
                    </>
                  ) : (
          ...
          <div className="bg-surface-card border border-accent-primary border-opacity-30 rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex space-x-4 mt-6">
              ...
              >
                {createUserLoading ? (
                  <>
                    <Loader size={16} ariaLabel="Creating user" />
                    Создание...
                  </>
                ) : (
          ...
          <div className="bg-surface-card border border-accent-primary border-opacity-30 rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex space-x-4 mt-6">
              ...
              >
                {editUserLoading ? (
                  <>
                    <Loader size={16} ariaLabel="Saving user" />
                    Сохранение...
                  </>
                ) : (
                  'Сохранить изменения'
