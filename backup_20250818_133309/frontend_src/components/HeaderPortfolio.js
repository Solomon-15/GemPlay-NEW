...
const HeaderPortfolio = ({ user }) => {
  ...
  return (
    <>
      <div className="flex space-x-1 sm:space-x-2 md:space-x-2 w-full mx-auto px-2 sm:px-4 md:px-6">
      ...
      <div className="bg-surface-card rounded-lg px-2 py-2 md:px-3 md:py-2 border border-green-500/20 hover:border-green-500/40 transition-colors duration-200 min-w-0 flex-1 md:flex-shrink-0 shadow-sm">
        <div className="text-center">
          ...
          <div className="font-rajdhani text-xs sm:text-sm md:text-xl font-bold text-green-400 break-words whitespace-nowrap">
      ...
      <div className="bg-surface-card rounded-lg px-2 py-2 md:px-3 md:py-2 border border-green-500/20 hover:border-green-500/40 transition-colors duration-200 min-w-0 flex-1 md:flex-shrink-0 shadow-sm">
        <div className="text-center">
          ...
          <div className="font-rajdhani text-xs sm:text-sm md:text-xl font-bold text-purple-400 break-words whitespace-nowrap">
      ...
      <div className="bg-surface-card rounded-lg px-2 py-2 md:px-3 md:py-2 border border-green-500/20 hover:border-green-500/40 transition-colors duration-200 min-w-0 flex-1 md:flex-shrink-0 shadow-sm">
        <div className="text-center">
          ...
          <div className="font-rajdhani text-xs sm:text-sm md:text-xl font-bold text-accent-primary break-words whitespace-nowrap">
