...
const HumanBotsManagement = ({ user: currentUser }) => {
  ...
  const [createFormData, setCreateFormData] = useState({
    ...
    bot_max_delay_seconds: 800,
    // Individual delay settings for bot-to-player games  
    player_min_delay_seconds: 20,
    player_max_delay_seconds: 800,
  ...
  const [bulkCreateData, setBulkCreateData] = useState({
    ...
    bot_min_delay_range: [20, 800],
    bot_max_delay_range: [20, 800],
    // Delay ranges for bot-to-player games
    player_min_delay_range: [20, 800], 
    player_max_delay_range: [20, 800],
  ...
  // Глобальные настройки удалены - используются индивидуальные настройки ботов
                    ...
                    <label>
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          setCreateFormData({
                            ...createFormData, 
                            can_play_with_other_bots: isChecked,
                            // При активации чекбокса установить значения по умолчанию
                            ...(isChecked && {
                              bot_min_delay_seconds: createFormData.bot_min_delay_seconds || 30,
                              bot_max_delay_seconds: createFormData.bot_max_delay_seconds || 2000
                            })
                          });
                        }}
                      />
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const value = Math.max(1, Math.min(12000, parseInt(e.target.value) || 20));
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const value = Math.max(1, Math.min(12000, parseInt(e.target.value) || 800));
                    ...
                    <label>
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          setCreateFormData({
                            ...createFormData, 
                            can_play_with_players: isChecked,
                            // При активации чекбокса установить значения по умолчанию
                            ...(isChecked && {
                              player_min_delay_seconds: createFormData.player_min_delay_seconds || 30,
                              player_max_delay_seconds: createFormData.player_max_delay_seconds || 2000
                            })
                          });
                        }}
                      />
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      max="100000"
                      placeholder="100"
                      value={bulkCreateData.bet_limit_amount_range ? bulkCreateData.bet_limit_amount_range[0] : 100}
                      onChange={(e) => setBulkCreateData({
                        ...bulkCreateData, 
                        bet_limit_amount_range: [parseInt(e.target.value) || 100, (bulkCreateData.bet_limit_amount_range && bulkCreateData.bet_limit_amount_range[1]) || 250]
                      })}
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setBulkCreateData({
                              ...
                              // При активации чекбокса установить значения по умолчанию  
                              ...(isChecked && {
                                bot_min_delay_range: bulkCreateData.bot_min_delay_range[0] ? bulkCreateData.bot_min_delay_range : [30, 2000],
                                bot_max_delay_range: bulkCreateData.bot_max_delay_range[0] ? bulkCreateData.bot_max_delay_range : [30, 2000]
                              })
                            });
                          }}
                        />
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setBulkCreateData({
                              ...
                              // При активации чекбокса установить значения по умолчанию
                              ...(isChecked && {
                                player_min_delay_range: bulkCreateData.player_min_delay_range[0] ? bulkCreateData.player_min_delay_range : [30, 2000],
                                player_max_delay_range: bulkCreateData.player_max_delay_range[0] ? bulkCreateData.player_max_delay_range : [30, 2000]
                              })
                            });
                          }}
                        />
